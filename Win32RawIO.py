...
class Win32RAWIO:
    ...
    def write(self, data):
        ...
        #win32file.SetFilePointer(self.iohandle, start_block*self.blocksize, win32file.FILE_BEGIN)
        #win32file.SetFilePointer(self.iohandle, self.offset, win32file.FILE_BEGIN)
        
        win32file.WriteFile(self.iohandle, data)
        #self.offset += size
...
if __name__ == '__main__':
    ...
    import time
    imagePath = r'D:\\Documents and Settings\\ram.RAMBASNET\\Desktop\\sandisk.dd'
    #win32file.SetVolumeMountPoint("C:\\MountPoint\\", imagePath)
    #win32file.DeleteVolumeMountPoint("C:\\MountPoint\\")
        
    try:
        rfin = Win32RAWIO(r'\\.\D:\\Documents and Settings\\ram.RAMBASNET\\Desktop\\sandisk.dd', 'r')
